...
public class FFT_PrimeiroTeste extends PApplet {
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "FFT_PrimeiroTeste" };
    if (passedArgs != null) {
